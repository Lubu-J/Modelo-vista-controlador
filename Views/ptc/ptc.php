                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($solicitudes as $row) {
                                                ...
                                                $idDocumento = isset($row["NombreDoc"]) ? $row["NombreDoc"] : '';
                                                $pdf = isset($row["DocumentoPDF"]) ? $row["DocumentoPDF"] : '';
                                                $estatusPTC = isset($row['EstatusPtc']) && $row['EstatusPtc'] == 1 ? 'Documento Válido' : 'Documento no Válido';
                                                $color = isset($row['EstatusVinc']) && $row['EstatusVinc'] == 1 ? 'green' : 'red';
                                                ...
                                                echo "<a href='ver_pdf.php?idDocumento=" . (isset($row["ID"]) ? $row["ID"] : '') . "' target='_blank' class='btn btn-sm btn-primary me-3'>Ver PDF</a>";
                                                echo "</td>";
                                                echo "<td class='status-cell' style='color: $color;'>$estatusPTC</td>";
                                                echo "<td class='status-cell' style='color: $color;'>$estatusVinc</td>";

                                                // Agregar un botón para visualizar el PDF
                                                echo "<td style='margin-left: 10px;'>";
                                                echo "<a href='?c=registro&a=estatus_documento&DocumentoPDF=" . (isset($row["DocumentoPDF"]) ? $row["DocumentoPDF"] : '') . "' class='btn btn-sm btn-warning me-3'>Validar/No Validar</a>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        </tbody>
